...
call(["raspistill -awb sun --colfx 128:128 -o " + host+filename], shell=True) # call external program ro take a picture
time.sleep(6)  # take about 6 seconds for the photo to be taken(?)
